function verAgregarUsuarioRutinas() {
    $.get('/gimnasio/administracion/usuariorutinas/add', {}, setFormulario);
}
...
function seleccionarRutina() {
    $.get('/gimnasio/administracion/rutinas/seleccionarRutina', {}, setSeleccionarRutinas);
}
...
function selectRutina(idRutina) {
    ...
    $.get('/gimnasio/administracion/rutinas/getRutina', {idRutina: idRutina}, setRutina);
}
