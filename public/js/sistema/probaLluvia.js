function verAgregarProbaLluvia() {
    $.get('/gimnasio/administracion/proballuvia/add', {}, setFormulario);
}
function verDetalle(idProbaLluvia) {
    $.get('/gimnasio/administracion/proballuvia/detail', {idProbaLluvia: idProbaLluvia}, setFormulario);
}
function verEditar(idProbaLluvia) {
    $.get('/gimnasio/administracion/proballuvia/edit', {idProbaLluvia: idProbaLluvia}, setFormulario);
}

function eliminar(idProbaLluvia) {
    if (confirm("¿ DESEA ELIMINAR ESTA PROBABILIDAD ?")) {
        $.post('/gimnasio/administracion/proballuvia/delete', {idProbaLluvia: idProbaLluvia}, setEliminarr, 'json');
    }
}
...
function knnlluvia() {
    ...
    $.post('/gimnasio/administracion/proballuvia/knnProbaLluvia', {dias: dias, lluviosos: lluviosos}, setFormulariosx, 'json');
}
