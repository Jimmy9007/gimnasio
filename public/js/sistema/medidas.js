function verAgregarMedidas() {
    $.get('/gimnasio/administracion/medidas/add', {}, setFormulario);
}
function verDetalle(idMedidas) {
    $.get('/gimnasio/administracion/medidas/detail', {idMedidas: idMedidas}, setFormulario);
}
function verEditar(idMedidas) {
    $.get('/gimnasio/administracion/medidas/edit', {idMedidas: idMedidas}, setFormulario);
}
//--------------------
function verConfiguracion(idMedidas) {
    $.get('/gimnasio/administracion/medidas/configuracion', {idMedidas: idMedidas}, setFormulario);
}
//--------------------
