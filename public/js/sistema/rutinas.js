function verAgregarRutinas() {
    $.get('/gimnasio/administracion/rutinas/add', {}, setFormulario);
}
function verAgregarRutinasAutomaticamente(idUsuario) {
    $.get('/gimnasio/administracion/rutinas/rutinaAutomatica', {idUsuario: idUsuario}, setFormulario);
}
function verDetalle(idRutinas) {
    $.get('/gimnasio/administracion/rutinas/detail', {idRutinas: idRutinas}, setFormulario);
}
function verEditar(idRutinas) {
    $.get('/gimnasio/administracion/rutinas/edit', {idRutinas: idRutinas}, setFormulario);
}
//--------------------
function verConfiguracion(idRutinas) {
    $.get('/gimnasio/administracion/rutinas/configuracion', {idRutinas: idRutinas}, setFormulario);
}
//--------------------
...
function seleccionarEjercicios(idRutina) {
    $.get('/gimnasio/administracion/ejercicios/seleccionarEjercicios', {idRutina: idRutina}, setSeleccionarRutinas);
}
...
function seleccionarInstructor() {
    $.get('/gimnasio/administracion/instructor/seleccionarInstructor', {}, setSeleccionarInstructores);
}
...
function selectInstructor(idInstructor) {
    $.get('/gimnasio/administracion/instructor/getInstructor', {idInstructor: idInstructor}, setInstructor);
}
...
function selectEjercicios(idEjercicios, idRutinas) {
    if (confirm("¿DESEA ANEXAR ESTE EJERCICIO AL ACTUAL RUTINA?")) {
        $.get('/gimnasio/administracion/formulario/setEjerciciosFormulario', {idEjercicios: idEjercicios, idRutinas: idRutinas}, setEjerciciosFormulario, 'json');
    } else {
...
function detalleEjercicio(idEjercicios) {//cuando presiona ver detalle del HTML
    $.post('/gimnasio/administracion/rutinas/getDetalleEjercicio', {idEjercicios: idEjercicios}, getDetalleEjercicio);
...
function eliminarEjercicio(idEjercicio) {
    ...
    if (confirm("¿ DESEA ELIMINAR ESTE EJERCICIO ?")) {
        $.post('/gimnasio/administracion/rutinas/deleteEjercicio', {idEjercicio: idEjercicio, idRutina: idRutina}, setEliminar, 'json');
        location.reload();
    }
}
