function verAgregarTurno() {
    $.get('/gimnasio/administracion/turno/add', {}, setFormulario);
}
function verDetalle(idTurno) {
    $.get('/gimnasio/administracion/turno/detail', {idTurno: idTurno}, setFormulario);
}
function verEditar(idTurno) {
    $.get('/gimnasio/administracion/turno/edit', {idTurno: idTurno}, setFormulario);
}
//--------------------
