function verAgregarPersonalizado() {
    $.get('/gimnasio/administracion/personalizado/add', {}, setFormulario);
}
function verDetalle(idPersonalizado) {
    $.get('/gimnasio/administracion/personalizado/detail', {idPersonalizado: idPersonalizado}, setFormulario);
}
function verEditar(idPersonalizado) {
    $.get('/gimnasio/administracion/personalizado/edit', {idPersonalizado: idPersonalizado}, setFormulario);
}
//--------------------
